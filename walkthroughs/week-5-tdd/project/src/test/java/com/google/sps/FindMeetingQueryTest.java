...
public final class FindMeetingQueryTest {
    ...
    public void unavailableOptionalAttendeeIgnored() {
        // Have each person have different events and person C has an all day event. 
        // We should see the same two options as if C was not present because there is no
        // possible time which includes them.
        //
        // Events  :       |--A--|     |--B--|
        //           |--------------C--------------|
        // Day     : |-----------------------------|
    ...
    public void optionalAttendeeConsidered() {
        // Have each person has events at different times. 
        // Person C is optional but there exists times which they can be included
        // so those times should be returned.
        //
        // Events  :       |--A--|--C--|--B--|
        // Day     : |-----------------------------|
        // Options : |--1--|                 |--2--|
    ...
    public void justEnoughRoomWithoutOptional() {
        // Considering B, the optional attendee, would result in a smaller timeslot than 
        // the requested amount. Thus, the timeslot returned should only consider A.
        // 
        //
        // Events  : |--A--|B-|  |----A----|
        // Day     : |---------------------|
    ...
    public void onlyOptionalWithRoom() {
        // Only optional attendees who have room in their schedules for an event.
        // The time they are both free should be returned.
        //
        // Events  : |--A--|     |----B----|
        // Day     : |---------------------|
        // Options :       |-----|
        ...
        MeetingRequest request = new MeetingRequest(new ArrayList<>(), DURATION_90_MINUTES);
    ...
    public void onlyOptionalNoRoom() {
        // Only optional attendees whose events overlap and fill the entire day.
        // No times are avalible.
        //
        // Events  : |-----A-----|----B----|
        // Day     : |---------------------|
        // Options :      
